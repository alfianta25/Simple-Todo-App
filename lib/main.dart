                          ...
                          child: ElevatedButton.icon(
                            onPressed: () {
                              if (eCtrl.text.isNotEmpty) {
                                Todo todo = Todo(eCtrl.text, false,
                                    undoneTodos.length + doneTodos.length + 1);
          ...
          Expanded(
              child: ListView.separated(
                  ...
                  separatorBuilder: (context, index) => Container(
                        child: Text("Todos Finished",
                            style: TextStyle(
                                fontSize:
                                    index == undoneTodos.length - 1 ? 16 : 0)),
                        decoration: BoxDecoration(
                            border: Border(
                                bottom: BorderSide(
                                    color: index == undoneTodos.length - 1
                                        ? Colors.grey
                                        : Colors.transparent,
                                    width:
                                        index == undoneTodos.length - 1 ? 1 : 0,
